...
$configs = [
    ...
    'Doctor' => [
        ...
        'searchPlaceholder' => 'Search patients, orders, results, facilities...',
        'notificationCount' => 5,
        ...
        'infoText' => 'Patients, orders, and results in one place.',
        'illustration' => $simpleClinicSvg,
        'nav' => clinic_route_nav([
            ['page' => 'dashboard', 'file' => 'dashboard', 'icon' => 'dashboard', 'label' => 'Dashboard'],
            ...
            ['page' => 'create-order', 'file' => 'create-order', 'icon' => 'plus-file', 'label' => 'Create Order'],
            ['page' => 'orders', 'file' => 'orders', 'icon' => 'orders', 'label' => 'My Orders', 'count' => 12],
            ['page' => 'results', 'file' => 'results', 'icon' => 'results', 'label' => 'Results', 'count' => 7],
            ['section' => 'Personal'],
            ['page' => 'notifications', 'file' => 'notifications', 'icon' => 'bell', 'label' => 'Notifications', 'count' => 5],
            ['page' => 'settings', 'file' => 'settings', 'icon' => 'settings', 'label' => 'Settings'],
        ]),
    ],
    'Laboratory Staff' => [
        ...
        'searchPlaceholder' => 'Search orders, patients, results, facilities...',
        'notificationCount' => 6,
        'drawerId' => 'lab-drawer',
        ...
        'nav' => clinic_route_nav([
            ['page' => 'dashboard', 'file' => 'dashboard', 'icon' => 'dashboard', 'label' => 'Dashboard'],
            ['page' => 'orders', 'file' => 'orders', 'icon' => 'orders', 'label' => 'Orders', 'count' => 18],
            ...
            ['section' => 'Personal'],
            ['page' => 'notifications', 'file' => 'notifications', 'icon' => 'bell', 'label' => 'Notifications', 'count' => 6],
            ['page' => 'settings', 'file' => 'settings', 'icon' => 'settings', 'label' => 'Settings'],
        ]),
    ],
    'Patient' => [
        ...
        'searchPlaceholder' => 'Search my orders, results, notifications...',
        'notificationCount' => 4,
        ...
        'nav' => clinic_route_nav([
            ['page' => 'dashboard', 'file' => 'dashboard', 'icon' => 'dashboard', 'label' => 'Dashboard'],
            ['page' => 'orders', 'file' => 'orders', 'icon' => 'orders', 'label' => 'My Orders', 'count' => 8],
            ['page' => 'results', 'file' => 'results', 'icon' => 'results', 'label' => 'My Results', 'count' => 4],
            ['page' => 'notifications', 'file' => 'notifications', 'icon' => 'bell', 'label' => 'Notifications', 'count' => 4],
            ['section' => 'My account'],
