<?php
$pageTitle = 'Create Patient Account | Clinic Management System';
$pageDescription = 'Create a secure Clinic Management System patient account';
$assetBase = '../assets';
    ...
    <main class="patient-register-shell">
      <section class="patient-register-visual">
        <a class="admin-brand register-brand" href="login.php#login">
          ...
          <span><strong>Clinic Management</strong><small>Secure patient portal</small></span>
        </a>
      ...
      <section class="patient-register-form-side">
        <div class="patient-register-card">
          <header><p class="eyebrow">Clinic Management System</p><h2>Create Patient Account</h2><p>Fill in your details to create your secure patient profile.</p></header>
          ...
          <form id="patient-register-form" novalidate>
            <div class="form-grid">
              ...
              <div class="form-field"><label for="patient-password">Password</label><div class="patient-password-wrap"><input id="patient-password" name="password" type="password" placeholder="At least 8 characters" autocomplete="new-password" required minlength="8"><button type="button" data-password-toggle="patient-password" aria-label="Show password">Show</button></div><small class="register-error"></small></div>
              <div class="form-field"><label for="patient-confirm">Confirm Password</label><div class="patient-password-wrap"><input id="patient-confirm" name="confirm" type="password" placeholder="Repeat password" autocomplete="new-password" required><button type="button" data-password-toggle="patient-confirm" aria-label="Show password">Show</button></div><small class="register-error"></small></div>
            </div>
