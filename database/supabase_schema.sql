...
CREATE TABLE IF NOT EXISTS laboratory_validation_rules (
  test_id INTEGER PRIMARY KEY REFERENCES test_definitions(id) ON DELETE CASCADE,
  rules_json TEXT NOT NULL
);
ALTER TABLE laboratory_validation_rules ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS laboratory_validation_reports (
...
CREATE INDEX IF NOT EXISTS idx_result_workflow_result ON result_workflow_events(result_id, created_at);
...
CREATE INDEX IF NOT EXISTS idx_login_attempts_blocked ON auth_login_attempts(blocked_until);
...
BEGIN
  FOREACH table_name IN ARRAY ARRAY[
    ...
    'lab_results', 'result_workflow_events', 'lab_result_values', 'result_files', 'clinical_notes',
